...
**Version**: 1.0.2 - Snappier Compatible
**GitHub**: https://github.com/Lesthat/dispatcharr_timeshift
**Original Plugin**: https://github.com/cedric-marcoux/dispatcharr_timeshift
**License**: MIT

## What's New in v1.0.2

This version adds **full compatibility with Snappier iOS** and improves support for multiple IPTV clients.

### Key Improvements

✅ **Snappier iOS Full Support**
- Fixed data type mismatches (channel_id, has_archive, timestamps)
- Fixed +2 hour timezone offset issue
- Programs now display at correct times

✅ **IPTVX Enhanced Support**
- XMLTV timezone conversion for accurate EPG display
- Fixes 1-hour offset in EPG times

✅ **EPG Improvements**
- Unique program IDs (timestamp-based)
- Standard date format (YYYY-MM-DD HH:MM:SS)
- Language field properly set

### Compatibility Matrix

| IPTV Client | Status | Notes |
|-------------|--------|-------|
| **iPlayTV** | ✅ Full | Catch-up functional |
| **IPTVX** | ✅ Full | With XMLTV timezone fix |
| **Snappier iOS** | ✅ Full | Data types + timezone fixes |

### Changelog

**v1.0.2** (2025-11-29)
- **Snappier compatibility**: Fixed JSON data type validation (channel_id, has_archive, timestamps)
- **Timezone fix**: Convert EPG timestamps to local time (matches real Xtream Codes providers)
- **EPG improvements**: Unique program IDs, standard date format, language field
- **Documentation**: Added comprehensive guides (CHANGES_SUMMARY.md, SNAPPIER_FIX_COMPLETE.md)
...
> **IMPORTANT**: After enabling or disabling this plugin, you must **refresh your source** in your IPTV player (e.g., iPlayTV, Snappier) for it to detect the timeshift/replay availability on channels.

## Features

- **100% Plugin Solution** - No modification to Dispatcharr source code required
- **Multi-Client Compatible** - Works with iPlayTV, IPTVX, Snappier iOS
- **Accurate Timezone Handling** - Matches real Xtream Codes provider behavior
- **Strict Type Validation** - Compatible with clients that validate JSON types
